...
import 'package:omi/login/mp_login_cubit.dart';
import 'package:omi/login/mp_login_state.dart';
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    if (state.mode == MPLoginMode.login) ...<Widget>[
                      const Spacer(),
                      GestureDetector(
                        onTap: () => _toast(context, 'Forgot password'),
                        child: const Text(
                          'Forgot Password?',
                ...
                Center(
                  child: GestureDetector(
                    ...
                    child: Text.rich(
                      TextSpan(
                        style: const TextStyle(fontSize: 15, color: secondTextColor),
                        children: <InlineSpan>[
                          TextSpan(
                ...
                _LegalFooter(
                  onTermsTap: () => _toast(context, 'Terms of Service'),
                  onPrivacyTap: () => _toast(context, 'Privacy Policy'),
                ),
              ],
            ),
          );
