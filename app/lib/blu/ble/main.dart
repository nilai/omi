...
/// BLE Debug Only mode - set to true for BLE solution provider test builds.
/// Strips all business features, skips auth, goes straight to BLE scan + debug page.
const bool kBleDebugOnly = false;
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ...
          // DeviceProvider needs CaptureProvider in normal mode, but in BLE debug mode
          // we create it standalone without the proxy dependency
          if (!kBleDebugOnly) ...[
