...
MPDeleteSpeakerRequest _$MPDeleteSpeakerRequestFromJson(Map<String, dynamic> json) => MPDeleteSpeakerRequest(
      speakerId: json['speaker_id'] as String,
    );

Map<String, dynamic> _$MPDeleteSpeakerRequestToJson(MPDeleteSpeakerRequest instance) => <String, dynamic>{
      'speaker_id': instance.speakerId,
    };

MPUpdateSpeakerRequest _$MPUpdateSpeakerRequestFromJson(Map<String, dynamic> json) => MPUpdateSpeakerRequest(
      speakerId: json['speaker_id'] as String,
      name: json['name'] as String?,
      avatar: json['avatar'] as String?,
    );

Map<String, dynamic> _$MPUpdateSpeakerRequestToJson(MPUpdateSpeakerRequest instance) => <String, dynamic>{
      'speaker_id': instance.speakerId,
      'name': instance.name,
      'avatar': instance.avatar,
    };
...
MPUpdateSpeakerResponse _$MPUpdateSpeakerResponseFromJson(Map<String, dynamic> json) => MPUpdateSpeakerResponse(
      baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$MPUpdateSpeakerResponseToJson(MPUpdateSpeakerResponse instance) => <String, dynamic>{
      'base_resp': instance.baseResp,
    };

MPDeleteSpeakerResponse _$MPDeleteSpeakerResponseFromJson(Map<String, dynamic> json) => MPDeleteSpeakerResponse(
      baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$MPDeleteSpeakerResponseToJson(MPDeleteSpeakerResponse instance) => <String, dynamic>{
      'base_resp': instance.baseResp,
    };
