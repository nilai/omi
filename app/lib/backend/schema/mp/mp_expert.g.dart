...
UserAddExpertRequest _$UserAddExpertRequestFromJson(Map<String, dynamic> json) => UserAddExpertRequest(
      expertId: json['expert_id'] as String,
    );

Map<String, dynamic> _$UserAddExpertRequestToJson(UserAddExpertRequest instance) => <String, dynamic>{
      'expert_id': instance.expertId,
    };

UserAddExpertResponse _$UserAddExpertResponseFromJson(Map<String, dynamic> json) => UserAddExpertResponse(
      baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$UserAddExpertResponseToJson(UserAddExpertResponse instance) => <String, dynamic>{
      'base_resp': instance.baseResp,
    };

UserCancelExpertRequest _$UserCancelExpertRequestFromJson(Map<String, dynamic> json) => UserCancelExpertRequest(
      expertId: json['expert_id'] as String,
    );

Map<String, dynamic> _$UserCancelExpertRequestToJson(UserCancelExpertRequest instance) => <String, dynamic>{
      'expert_id': instance.expertId,
    };

UserCancelExpertResponse _$UserCancelExpertResponseFromJson(Map<String, dynamic> json) => UserCancelExpertResponse(
      baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$UserCancelExpertResponseToJson(UserCancelExpertResponse instance) => <String, dynamic>{
      'base_resp': instance.baseResp,
    };
