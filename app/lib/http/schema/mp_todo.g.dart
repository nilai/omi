...
GetTodoGroupedListRequest _$GetTodoGroupedListRequestFromJson(Map<String, dynamic> json) =>
    GetTodoGroupedListRequest(pageSize: (json['page_size'] as num).toInt(), pageno: (json['page_no'] as num).toInt());

Map<String, dynamic> _$GetTodoGroupedListRequestToJson(GetTodoGroupedListRequest instance) => <String, dynamic>{
...
Map<String, dynamic> _$GetTodoGroupedListResponseToJson(GetTodoGroupedListResponse instance) => <String, dynamic>{
...
TodoListSectionStruct _$TodoListSectionStructFromJson(Map<String, dynamic> json) => TodoListSectionStruct(
...
Map<String, dynamic> _$TodoListSectionStructToJson(TodoListSectionStruct instance) => <String, dynamic>{
...
MPCreateTodoResponse _$MPCreateTodoResponseFromJson(Map<String, dynamic> json) =>
    MPCreateTodoResponse(baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>));
...
MPDoneTodoResponse _$MPDoneTodoResponseFromJson(Map<String, dynamic> json) =>
    MPDoneTodoResponse(baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>));

Map<String, dynamic> _$MPDoneTodoResponseToJson(MPDoneTodoResponse instance) => <String, dynamic>{
  'base_resp': instance.baseResp,
};

MPDeleteTodoResponse _$MPDeleteTodoResponseFromJson(Map<String, dynamic> json) =>
    MPDeleteTodoResponse(baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>));

Map<String, dynamic> _$MPDeleteTodoResponseToJson(MPDeleteTodoResponse instance) => <String, dynamic>{
  'base_resp': instance.baseResp,
};

MPUpdateTodoResponse _$MPUpdateTodoResponseFromJson(Map<String, dynamic> json) =>
    MPUpdateTodoResponse(baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>));

Map<String, dynamic> _$MPUpdateTodoResponseToJson(MPUpdateTodoResponse instance) => <String, dynamic>{
  'base_resp': instance.baseResp,
};

MPBatchCreateTodoItem _$MPBatchCreateTodoItemFromJson(Map<String, dynamic> json) => MPBatchCreateTodoItem(
  title: json['title'] as String,
  priority: json['priority'] as String,
  deadline: (json['deadline'] as num).toInt(),
  memoryId: json['memory_id'] as String?,
...
Map<String, dynamic> _$MPBatchCreateTodoItemToJson(MPBatchCreateTodoItem instance) => <String, dynamic>{
  'title': instance.title,
  'priority': instance.priority,
  'deadline': instance.deadline,
  'memory_id': instance.memoryId,
...
MPBatchCreateMemoItem _$MPBatchCreateMemoItemFromJson(Map<String, dynamic> json) => MPBatchCreateMemoItem(
  content: json['content'] as String,
  createAt: (json['create_at'] as num).toInt(),
  memoryId: json['memory_id'] as String?,
);

Map<String, dynamic> _$MPBatchCreateMemoItemToJson(MPBatchCreateMemoItem instance) => <String, dynamic>{
  'content': instance.content,
  'create_at': instance.createAt,
  'memory_id': instance.memoryId,
};

MPBatchCreateRequest _$MPBatchCreateRequestFromJson(Map<String, dynamic> json) => MPBatchCreateRequest(
...
Map<String, dynamic> _$MPBatchCreateRequestToJson(MPBatchCreateRequest instance) => <String, dynamic>{
  'todos': instance.todos,
  'memos': instance.memos,
};

MPBatchCreateResponse _$MPBatchCreateResponseFromJson(Map<String, dynamic> json) => MPBatchCreateResponse(
  todoCount: (json['todo_count'] as num).toInt(),
  memoCount: (json['memo_count'] as num).toInt(),
  baseResp: MPBaseResp.fromJson(json['base_resp'] as Map<String, dynamic>),
);

Map<String, dynamic> _$MPBatchCreateResponseToJson(MPBatchCreateResponse instance) => <String, dynamic>{
