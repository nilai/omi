...
import '../audio_record/page.dart';
import '../debug/summary_debug_page.dart';
        ...
        children: [
          ...
          _buildSectionContainer(
            children: [
              ...
              _buildSettingsItem(
                title: 'Audio Upload',
                icon: const FaIcon(FontAwesomeIcons.fileAudio, color: Color(0xFF8E8E93), size: 20),
                onTap: () {
                  Navigator.pop(context);
                  Navigator.of(context).push(
                    MaterialPageRoute(
              ...
              _buildSettingsItem(
                ...
                onTap: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const SummaryDebugPage(),
                    ),
                  );
                },
              ),
